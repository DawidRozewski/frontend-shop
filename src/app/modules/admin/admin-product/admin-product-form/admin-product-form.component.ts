  ...
  template: `
    <div [formGroup]="parentForm" fxLayout="column">
      <mat-form-field appearance="fill">
        ...
        <input matInput placeholder="Dodaj nazwe produktu" formControlName="name">
      ...
      <mat-form-field appearance="fill">
        ...
        <textarea matInput rows="40"
                  placeholder="Podaj pełny opis produktu" formControlName="fullDescription">
        </textarea>
      </mat-form-field>
